...
;define('translation:widget/translate/desktopGuideWrap/DesktopGuide/DesktopGuide.jsx', function(require, exports, module) {

  'use strict';

  var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @file 桌面端导流浮层 (PC V3.11.2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @author 任云 <renyun01@baidu.com>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            */
  ...
  var DESKTOP_GUIDE_HAS_SEEN_LS_KEY = 'DESKTOP_GUIDE_HAS_SEEN_1';
  ...
  function DesktopGuide() {
      ...
      var handleDownload = function handleDownload() {
          window._hmt.push(['_trackEvent', '首页', '首页客户端导流浮层下载按钮点击']);
          window.open(window.location.origin + '/client/download/redirect?from=pcDesktopGuide');
      };

      var handleClose = function handleClose() {
          window._hmt.push(['_trackEvent', '首页', '首页客户端导流浮层关闭按钮点击']);
          setIsHide(true);
      };

      (0, _react.useEffect)(function () {
          window._hmt.push(['_trackEvent', '首页', '首页客户端导流浮层展现量']);
          try {
              localStorage.setItem(DESKTOP_GUIDE_HAS_SEEN_LS_KEY, 'y');
          } catch (e) {
              console.warn(e);
          }
      }, []);
      ...
      return _react2.default.createElement(
          'div',
          {
              className: (0, _classnames2.default)('desktop-guide', {
                  'desktop-guide-hide': isHide
              })
          },
          _react2.default.createElement(
              'div',
              { className: 'desktop-guide-outter' },
              _react2.default.createElement(
                  'div',
                  { className: 'desktop-guide-inner' },
                  _react2.default.createElement('div', { className: 'desktop-guide-screenshot' }),
                  _react2.default.createElement('div', { className: 'desktop-guide-feat' }),
                  _react2.default.createElement('a', { className: 'desktop-guide-dl-btn', onClick: handleDownload }),
                  _react2.default.createElement('a', { className: 'desktop-guide-close', onClick: handleClose })
              )
          )
      );
  }

  function initDesktopGuide() {
      // iPad 上出的是 pc 的页面，输入法那边期望把广告浮层下掉
      if (/baiduinput/ig.test(window.navigator.userAgent)) {
          return;
      }
      // 如果配置着 app 导流浮层，客户端浮层也不展示
      if (window.appVersion != null) {
          return;
      }

      var hasSeenGuide = void 0;
      try {
          hasSeenGuide = localStorage.getItem(DESKTOP_GUIDE_HAS_SEEN_LS_KEY) === 'y';
      } catch (e) {
          hasSeenGuide = false;
      }
      ...
      _reactDom2.default.render(_react2.default.createElement(DesktopGuide, null), document.getElementById('desktop-guide-wrapper'));
  }
...
;define("translation:widget/translate/desktopGuideWrap/desktopGuideWrap",function(t){"use strict";t("translation:widget/translate/desktopGuideWrap/DesktopGuide/DesktopGuide.jsx")
});
...
;define("translation:widget/translate/sideNav/sideNav",function(t,e,n){"use strict";var a=t("translation:widget/common/third_party/template"),i=t("translation:widget/common/environment"),o=t("translation:widget/translate/sideNav/navSorter/navSorter"),s=($(".footer"),$("#side-nav")),r=s.find(".sidv-nav-position-layer .side-nav-wrapper"),c=21,l=12,d=$(".trans-other-wrap .trans-left"),f=0,v=[],u=$(window).height(),m=0,h=!1,p=!1,w=!1,g=!1,b={oxford:"牛津词典",which_word:"词语辨析",vocab:"词汇扩充",british_american:"英美用法",grammar:"语法说明",more_about:"补充说明",synonyms:"同义词辨析",edict:"英英释义",sample:"双语例句",zdict:"中中释义",collins:"柯林斯词典",hanying:"汉英大词典",general:"单词集锦"},_=0,k={init:function(){k.bindScroll(),k.bindResize(),k.bindClick()
},mockScrollingClickFlag:function(t){w=t},scrollToSection:function(t){var e=v[t].topOffset-l;w=!0,$("html:not(:animated), body:not(:animated)").animate({scrollTop:e},300,"swing",function(){var e=i.get("collapse");
e.expandSection(v[t].ele),w=!1,k.checkPos()})},locateTab:function(){var t=b[k.getParamFromUrl("mod")];if(t){var e=$(".nav-item, .nav-sub-item").filter("[data-stat-add='"+t+"']");
e.length>0&&(k.scrollToSection(parseInt(e.attr("data-section-idx"),10)),window._hmt.push(["_trackEvent","首页","37_首页页面_点击目录项_"+t]))
}},bindClick:function(){s.on("click.sideNav",".nav-item, .nav-sub-item",function(t){var e=$(t.currentTarget),n=parseInt(e.attr("data-section-idx"),10);
k.scrollToSection(n)}),s.on("click",".nav-search-again",function(){var t=void 0,e=void 0;$("html:not(:animated), body:not(:animated)").animate({scrollTop:"0px"},100);
var n=document.getElementById("baidu_translate_input");if("undefined"!=typeof n.createTextRange){var a=n.createTextRange();
...
}else"undefined"!=typeof n.setSelectionRange&&(t=0,e=n.value.length,n.setSelectionRange(t,e));setTimeout(function(){n.focus()
},500),window._hmt.push(["_trackEvent","首页","web端点击继续查词"])}),s.on("click",".nav-sort-btn",function(){o.show()})},bindResize:function(){$(window).on("resize.sideNav",function(){u=$(window).height(),h&&(k.setupPos(),k.checkPos())
})},bindScroll:function(){$(window).on("scroll.sideNav",function(){if(h){k.setNavPos(),k.checkPos(),clearTimeout(_);var t=s.find(".nav-item, .nav-sub-item");
_=setTimeout(function(){$(t).each(function(t,e){var n=$(e).attr("data-stat-add");$(e).hasClass("in-view")&&window._hmt.push(["_trackEvent","首页","48_首页页面_模块滑动停留次数_"+n])
})},5e3)}})},genNav:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:!0;if(k.destroyNav(),$(".result-section").each(function(t,e){var n=$(e),a=n.attr("data-nav-text"),i=n.hasClass("nav-sub-section"),o=n.hasClass("prefix-new-tag");
v.push({ele:n,title:a,isSub:i,isNew:o}),_hmt.push(["_trackEvent","首页","Web"+a+"Tab展现量"])}),v.length>0){var e=a("tplSideNav",{sectionData:v,withSortBtn:t});
...
}},setNavPos:function(){var t=$(window).scrollTop(),e=d.offset().top;if(e>m-f&&(m=e+f,this.setupPos()),t>m-c){s.addClass("fixed");
var n=window.pageXOffset||0;s.css("left",-n)}else s.removeClass("fixed"),s.css("left","")},setupPos:function(){p||v.forEach(function(t){var e=t.ele,n=e.height();
t.topOffset=e.offset().top,t.bottomOffset=t.topOffset+n})},checkPos:function(){var t=$(window).scrollTop();if(!p&&!w){var e=t+l,n=t+u,a=null,i=null,o=s.find(".nav-item, .nav-sub-item");
o.removeClass("active").removeClass("in-view"),v.forEach(function(t,s){var r=t.topOffset>=e&&t.topOffset<=n||t.bottomOffset>e&&t.bottomOffset<=n||t.topOffset<e&&t.bottomOffset>n;
...
f.hasClass("active")&&(d=!0,i=s)}}else null===a&&(d=!0,a=s);d&&c.addClass("active")}})}},destroyNav:function(){r.empty(),s.removeClass("fixed").css("left",""),v=[],m=0,h=!1,p=!1,w=!1,clearTimeout(_),_=0,d.css("padding-bottom","")
},getParamFromUrl:function(t){var e=new RegExp("(^|&)"+t+"=([^&]*)(&|$)","i"),n=window.location.search.substring(1).match(e);
return null!==n?n[2]:null}};k.init(),n.exports=k});
...
;define("translation:widget/translate/details/dictionary/simplemeans",function(t,e){"use strict";function n(t){return t&&t.__esModule?t:{"default":t}
}function a(t,e){var n="explain_video_play",a=JSON.stringify({video_id:t,source:"pc",type:e});r.default.newFetch("/track",{key:n,params:a,sign:d.default("key"+n+"params"+a+n)},"POST",void 0,!0).catch(function(){})
}function i(t){t=Number(t);var e=Math.floor(t/60),n=t%60;return e+":"+(10>n?"0"+n:n)}var o=t("translation:widget/common/fanyiUtil"),r=n(o),s=t("translation:widget/common/third_party/md5"),d=n(s),c=t("translation:widget/common/third_party/template"),u=t("translation:widget/common/soundURIGenerator"),p=t("translation:widget/translate/output/mouseover"),l=t("translation:widget/common/environment");
c.helper("uriComponentTrimAndEncode",function(t){return encodeURIComponent($.trim(t))});var h,g,v,m=!0,f=8,_=$("#left-result-container"),w={START_PLAY:1,EFFECTIVE_PLAY:2,ALMOST_END:3,END_PLAY:4},y={buildSimpleMeans:function(t){var e=t.data,n=(t.to,t.baikeImgUrl),o=t.queryExplainVideo,r=2===parseInt(l.get("firstModuleId"),10);
_.append(c("tplDictionary",{isFirstCard:r}));var s,d={};d.tplData=e;var u=$(".select-from-language .language-selected").attr("data-lang"),p=$(".select-to-language .language-selected").attr("data-lang"),h=!1;
...
}if(e.exchange)for(var v in e.exchange)e.exchange[v]&&(h=!0);if(d.tplData.showExchange=h,"zh"===u&&"en"===p&&(d.tplData.isZh2En=!0,_hmt.push(["_trackEvent","首页","Web中英词典释义卡片展现次数"])),d.tplData.symbols?(o?(o.formatDur=i(o.videoTime),d.tplData.queryExplainVideo=o,_hmt.push(["_trackEvent","首页","84_首页页面_Web词典释义卡片_讲解视频缩略图展现次数_"+o.videoType])):n&&(d.tplData.baikeImgUrl=n,_hmt.push(["_trackEvent","首页","64_首页页面_Web词典释义卡片_图片展现次数"])),d.tplData.isFirstCard=r,s=c("tplSimplemeans",d),e.memory_skill&&_hmt.push(["_trackEvent","首页","73_首页页面_Web词典释义卡片_记忆技巧展现次数"]),e.derivative&&_hmt.push(["_trackEvent","首页","80_首页页面_Web词典释义卡片_派生词展现次数"])):d.tplData.content&&(s=c("tplOtherSimplemeans",d)),_.find(".dictionary-wrap").html(s),o){var m=$(".dictionary-wrap .query-video"),f=m[0],y=o.id,b=!0,k=!1,E=!1;
m.on("play",function(){b&&(window._hmt.push(["_trackEvent","首页","86_首页页面_Web词典释义卡片_讲解视频首帧播放次数_"+o.videoType]),a(y,w.START_PLAY)),b=!1
}),m.on("timeupdate",function(){var t=f.duration,e=f.currentTime;!k&&e>10&&(a(y,w.EFFECTIVE_PLAY),k=!0),!E&&e/t>.9&&(a(y,w.ALMOST_END),E=!0)
}),m.on("ended",function(){window._hmt.push(["_trackEvent","首页","87_首页页面_Web词典释义卡片_讲解视频尾帧播放次数_"+o.videoType]),a(y,w.END_PLAY),b=!0
...
},bindEvents:function(){var t=this,e=!1,n=0,a=0,i=0,o=0,r=0,s=0,d=30;$(".translate-wrap").on("click",".dictionary-wrap .op-sound",function(){t.timer&&clearTimeout(t.timer),t.clickSound({target:this})
...
}).off("click.sound").on("click.sound","a",function(){var e=$(this),n=e.attr("href")||"";(n.match(/[\.\/]/g)||e.hasClass("collection-btn"))&&t.shutdownAudio()
...
e.css({position:"fixed",left:n,top:Math.min(Math.max(d,a),$(window).height()-e.height())}),e.css("visibility","visible"),$(".dictionary-wrap .query-video")[0].play()
},100)}).on("click",".video-close",function(){$(".dictionary-wrap .query-video")[0].pause(),$(".dictionary-wrap .video-container").removeAttr("style")
}),$(".translate-wrap").on("mousedown.dragVideo",".video-top-bar",function(t){if(0===t.button){e=!0;var c=$(".dictionary-wrap .video-container"),u=c[0].getBoundingClientRect(),p=u.left,l=u.top;
n=t.clientX-p,a=t.clientY-l,c.addClass("dragging"),i=$(window).width(),o=$(window).height(),r=c.width(),s=c.height(),$(document).on("mousemove.dragVideo",function(t){e&&$(".dictionary-wrap .video-container").css({left:Math.min(Math.max(0,t.clientX-n),i-r),top:Math.min(Math.max(d,t.clientY-a),o-s)})
...
})},clickSound:function(t){var e=$(t.target);this.judgeStopRepeat();var n=u.generateURI({lan:e.attr("data-sound-lan"),text:e.attr("data-sound-text")});
BTPM.setUrl(n);var a;e.addClass("op-sound-active"),a&&clearTimeout(a),a=setTimeout(function(){e.removeClass("op-sound-active")
},2e3),_hmt.push(["_trackEvent","首页","web端简明释义TTS"])},repeatSound:function(t){var e=this,n=$(t.target);if(n.hasClass("op-repeat-running"))p.isover({target:t.target,text:"复读"}),e.shutdownRepeat(),_hmt.push(["_trackEvent","首页","web端复读按钮停止点击"]);
else{if(e.shutdownRepeat(),f=8,n.addClass("op-repeat-running"),v=u.generateURI({lan:n.attr("data-sound-lan"),text:n.attr("data-sound-text")}),BTPM.setUrl(v),f--,p.isover({target:t.target,text:"停止复读"}),n.attr("data-hover-tip-text","停止复读"),"IE"===BTPM.stage){var a=n.siblings("b").text();
if(a&&a.length>0){a=a.match(/\[(.*)\]/)[1];var i=e.getRepeatDuration(a);h=setInterval(function(){return 1>f?void e.shutdownRepeat():(BTPM.setUrl(v),void f--)
},i)}}else m=!0,$(BTPM).off("ended.repeating").on("ended.repeating",function(){return m?1>f?void e.shutdownRepeat():void(g=setTimeout(function(){BTPM.setUrl(v),f--
},1200)):void 0});_hmt.push(["_trackEvent","首页","web端复读按钮播放点击"])}},shutdownRepeat:function(t){$(".op-repeat").removeClass("op-repeat-running").attr("data-hover-tip-text","复读"),t&&t.nopause||BTPM.doPause(),"IE"===BTPM.stage?clearInterval(h):(clearTimeout(g),m=!1,$(BTPM).off("ended.repeating"))
},getRepeatDuration:function(t){t=t.replace(/[\s:ˌ']|(\(\w*\))/g,"");var e,n=t.length;return e=4>=n?2e3:n>5&&10>=n?3e3:n>10&&18>=n?4e3:5e3
},bindRepeatEvents:function(){var t=this;$(".container").off("click.repeatthing").on("click.repeatthing","a",function(){var e=$(this),n=e.attr("href")||"";
...
},isoverSound:function(t){if("hover"===l.get("soundTriggerMode")){var e=this;this.timer=setTimeout(function(){e.clickSound({target:t.target})
...
},shutdownAudio:function(){BTPM.doPause()}};$(function(){y.bindEvents()}),e.buildSimpleMeans=function(t){y.buildSimpleMeans(t)
},e.judgeStopRepeat=function(){y.judgeStopRepeat()},e.translateStopRepeat=function(){y.translateStopRepeat()},e.shutdownAudio=function(){y.shutdownAudio()
},e.shutdownRepeat=function(){y.shutdownRepeat()}});
...
break}return t.next=4,i.getCollGroupListAsync();case 4:r=t.sent,r.forEach(function(t){t.nameDisplayLength=a(t.name)}),e.groupList=r;
...
;define("translation:widget/translate/input/inputCollGroup/inputCollGroup",function(n,o,t){"use strict";n("translation:widget/common/third_party/jquery_scrollbar/jquery_scrollbar");
var i=n("translation:widget/common/third_party/template"),e=n("translation:widget/translate/favo/collInfo"),l=n("translation:widget/common/environment"),a=n("translation:widget/common/collGroupUtil"),r=n("translation:widget/common/util").getDisplayLength,c=$(".input-coll-extra-container"),u=$(".input-coll-extra-container ol.input-coll-ol"),s=$(".input-coll-extra-container .new-group-name"),p=$(".input-coll-extra-container .new-group-confirm"),d=$(".input-coll-extra-container .new-coll-group-err-msg"),f=$(".input-coll-extra-container .close-input-coll-group"),g=$(".op-favor-container"),h=$(".op-favor-container .op-favo"),m=$(".input-coll-extra-container .add-new-group"),v=$(".input-coll-extra-container .new-coll-group-input-container"),w=null,C={show:function(){_hmt.push(["_trackEvent","首页","17_首页页面_输入框收藏分组列表浮层展示"]),u.empty(),e.getCollGroupListAsync().then(function(){var n=i("tpl-input-ol",{groupList:l.get("collInfo").groupList});
u.html(n),m.show(),v.hide(),c.show(),h.addClass("op-favo-hover")})},hide:function(){c.hide(),s.val(""),p.addClass("disabled-new-group-confirm"),d.hide(),h.removeClass("op-favo-hover")
},init:function(){$(".input-coll-ol.scrollbar-inner").scrollbar({disableBodyScroll:!0}),C.bindEvent()},bindEvent:function(){$(document).on("click",function(n){var o=$(n.target);
"none"===c.css("display")||o.is(g)||0!==g.has(o).length||C.hide()}),u.on("click",".input-coll-li",function(){var n=l.get("inputFavo");
n.add($(this).attr("data-group-id"))}),m.on("click",function(){m.hide(),v.show()}),s.on("input",function(){$(this).val()||$(this)[0].value?p.removeClass("disabled-new-group-confirm"):p.addClass("disabled-new-group-confirm")
}),p.on("click",C.newGroupAndAddColl),s.keydown(function(n){return 13===parseInt(n.keyCode,10)?(n.preventDefault(),C.newGroupAndAddColl(),!1):void 0
}),f.on("click",function(){C.hide()})},newGroupAndAddColl:function(){if(!p.hasClass("disabled-new-group-confirm")){_hmt.push(["_trackEvent","首页","19_首页页面_输入框收藏分组创建并添加按钮点击"]);
var n=s.val()||s[0].value;a.newCollGroupAsync(n,!1).then(function(o){l.get("collInfo").groupList.push({name:n,id:o,nameDisplayLength:r(n)}),l.get("inputFavo").add(o)
},function(n){w&&clearTimeout(w),d.text("创建失败："+n),d.show(),setTimeout(function(){d.slideUp()},2e3)})}}};t.exports=C});
...
;define("translation:widget/translate/favo/favo",function(t,e,n){"use strict";function o(t){return t&&t.__esModule?t:{"default":t}
}function i(t){return function(){var e=t.apply(this,arguments);return new Promise(function(t,n){function o(i,r){try{var s=e[i](r),a=s.value
}catch(d){return void n(d)}return s.done?void t(a):Promise.resolve(a).then(function(t){o("next",t)},function(t){o("throw",t)
})}return o("next")})}}function r(t){this.pos=t.pos||"input",this.$btn=$(t.target),this.ts=0,this.handles={change:[]}}var s=t("translation:widget/redux/store"),a=o(s),d=t("translation:widget/redux/indexInfo/noteInfo"),c=t("translation:widget/common/fanyiUtil"),u=o(c),l=t("translation:widget/translate/favo/commonCollGroup/commonCollGroup.jsx"),h=t("translation:widget/login/login"),f=t("translation:widget/translate/output/mouseover"),p=t("translation:widget/common/environment"),v=t("translation:widget/translate/favo/favoHelper"),y=t("translation:widget/translate/favo/collInfo"),w=t("translation:widget/translate/input/inputCollGroup/inputCollGroup"),g=t("translation:widget/translate/zonedword/zonedCollGroup/zonedCollGroup");
r.prototype={constructor:r,init:function(t){var e=t.query.replace(/<br( \/)?>/gi,"&lt;br$1&gt;"),n=t.from+"2"+t.to,o=+new Date;
...
},bindEvent:function(){var t=this;this.$btn.on("click.favo",function(){var e=p.get("account");""!==e.is_login?(t.saved?t.deleteItem():y.getDefaultGroupAsync().then(function(){var e=p.get("collInfo");
-1!==e.defaultId?t.add(e.defaultId):"input"===t.pos?w.show():"zonedword"===t.pos&&"none"===$(".zoned-coll-extra-container").css("display")?g.show():"keyword"===t.pos&&l.createCommonCollGroup({containerEle:t.$btn.siblings(".keyword-coll-group-container")[0],favorInstance:t})
...
})},check:function(){var t=p.get("account");if(""!==t.is_login){var e=this;!function(t,n){$.ajax({url:"/pcnewcollection?req=check",type:"GET",data:{fanyi_src:e.query,direction:e.direction},datatype:"json",cache:!1,success:function(o){if(0===o.errno?e.favorIsSaved({id:o.id,firstScreen:!0,reqQurey:t,reqDirection:n}):e.favorIsNotSaved({reqQurey:t,reqDirection:n}),"input"===e.pos){var i=o.note,r=o.report;
i||(i=""),r||(r=""),a.default.dispatch(i||r?d.updateNoteInfo({showNotePanel:!0,noteContent:i,reportContent:r,hasModified:!1}):d.clearNoteInfo())
}},error:function(){e.favorIsNotSaved({reqQurey:t,reqDirection:n})}})}(this.query,this.direction)}},favorIsSaved:function(t){if(this.query===t.reqQurey&&this.direction===t.reqDirection){var e=this.$btn;
this.saved=!0,this.id=t.id;var n=t.firstScreen||!1;n||(e.attr("data-hover-tip-text","已收藏"),f.isover({target:e[0]}),setTimeout(function(){f.isout()
...
var e=this.$btn;e.attr({"data-hover-tip-text":"添加到收藏夹",title:"添加到收藏夹"}).removeClass("op-favo-cur"),t.firstScreen&&(e.attr("data-hover-tip-text","已取消收藏"),f.isover({target:e[0]}),setTimeout(function(){f.isout(),e.attr("data-hover-tip-text","添加到收藏夹")
},2e3))}},add:function(t){var e=this;return new Promise(function(n,o){var i={fanyi_src:e.query,direction:e.direction,gid:t,bdstoken:window.bdstoken};
...
var r=p.get("maxCollectionCount");if(e.query.length>r||i.fanyi_dst.length>r)return alert("囧, 原文和译文要是在"+r+"字以下就好啦 ^_^"),void o();
...
var s=e;!function(t,e){$.ajax({url:"/pcnewcollection?req=add",type:"POST",data:i,datatype:"json",success:function(i){0===i.errno?(s.favorIsSaved({id:i.id,reqQurey:t,reqDirection:e}),"input"===s.pos?w.hide():"zonedword"===s.pos?g.hide():"keyword"===s.pos&&l.destroyCommonCollGroup({containerEle:s.$btn.siblings(".keyword-coll-group-container")[0],favorInstance:s}),s.trigger("change"),n()):(s.favorIsNotSaved({reqQurey:t,reqDirection:e}),o())
},error:function(){o()}})}(e.query,e.direction)})},deleteItem:function(){if(void 0!==this.id&&null!==this.id){"input"===this.pos?_hmt.push(["_trackEvent","首页","web端输入框取消收藏点击次数"]):"zonedword"===this.pos?_hmt.push(["_trackEvent","首页","web端划词框取消收藏点击次数"]):"keyword"===this.pos&&_hmt.push(["_trackEvent","首页","web端重点词汇取消收藏点击次数"]);
var t=this;!function(e,n){$.ajax({url:"/pcnewcollection?req=del",type:"POST",data:{id:t.id,bdstoken:window.bdstoken},datatype:"json",success:function(o){0===o.errno&&(t.favorIsNotSaved({firstScreen:!0,reqQurey:e,reqDirection:n}),t.trigger("change"))
}})}(this.query,this.direction)}},saveNote:function(t){var e=this;return i(regeneratorRuntime.mark(function n(){var o;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(o=e,o.saved){n.next=4;
break}return n.next=4,o.add(0);case 4:return n.next=6,u.default.newFetch("/pc/collection/modify",{id:o.id,bdstoken:window.bdstoken,note:t});
case 6:case"end":return n.stop()}},n,e)}))()},on:function(t,e){return this.handles[t]&&"[object Function]"===Object.prototype.toString.call(e)?(this.handles[t].push(e),this):void 0
},off:function(t){return this.handles[t]=[],this},trigger:function(t){var e=this;$.each(this.handles[t],function(t,n){n.call(e)
})}},n.exports=r});
...
return!this.isEnglishQuery(t)||t.length>20||t.length<3?void $(".trans-correct").hide():(clearTimeout(e),void(e=setTimeout(function(){var e=n.get("lastquery");
t!==e&&(n.set("lastquery",t),r.ajaxCorrect(t))},300)))},getCorrect:function(t){if(this.setLastInput(t),!this.isQueryInCheck()){if(!this.isEnglishQuery(t)||t.length>20||t.length<3)return void $(".trans-correct").hide();
...
},bindEvents:function(){p.init(),u.bindEvents(),d.init(),g.bindEvents(),c.bindEvents()},normaltrans:function(t){for(var a=t.data.data,p=t.data.jp_pinyin,u=t.data.phonetic,d={},g=$(".select-to-language .language-selected").attr("data-lang"),c=$(".select-from-language .language-selected").attr("data-lang"),D=e.get("rtl"),y=$.inArray(g,D)>=0,h=$.inArray(c,D)>=0,w=$.inArray(g,["ara","ru","el"])>=0,C="",I=a.length,k=[],L=[],H=0;I>H;H++){var N=a[H].dst;
L.push(N);{a[H].src}k.push(parseInt(a[H]||0)),Array.isArray(a[H].result)||(a[H].result=[]);for(var A=0,_=a[H].result.length;_>A;A++){var b=a[H].result[A][5].toString().split("|"),S=parseInt(b[0],10),B=parseInt(b[1],10);
a[H].result[A][6]=w?a[H].result[A][1]:r.cutByByte(N,S,S+B)}}C+=L.join("\r\n");for(var T="",j=L.length,A=0;j>A;A++){var E=f.encodeHTML(L[A]);
...
}}}var q=v.getCookie("DOUBLE_LANG_SWITCH"),F=!1;"1"===q&&(F=!0),d.tplData.doubleLangChecked=F,d.tplData.dir=y?"rtl":"ltr",d.tplData.srcDir=h?"rtl":"ltr",d.tplData.spell="",r.getByte(C)<=i.getMaxSoundLength(g)&&(d.tplData.spell=encodeURIComponent(C)),d.tplData.spellLang="",i.isLangSound(g)&&(d.tplData.spellLang="yue"==g?"cte":g),w&&(d.tplData.needSpace="yes"),n.config("compress",!0);
...
;define('translation:widget/translate/output/SideBanner/SideBanner.jsx', function(require, exports, module) {
  ...
  exports.initSideBanner = initSideBanner;
  ...
  var _moment = require('translation:node_modules/moment/moment');

  var _moment2 = _interopRequireDefault(_moment);

  var _fanyiUtil = require('translation:widget/common/fanyiUtil');

  var _fanyiUtil2 = _interopRequireDefault(_fanyiUtil);
  ...
  var SideBanner = function (_React$Component) {
      _inherits(SideBanner, _React$Component);

      function SideBanner(props) {
          _classCallCheck(this, SideBanner);

          var _this = _possibleConstructorReturn(this, (SideBanner.__proto__ || Object.getPrototypeOf(SideBanner)).call(this, props));

          _this.handleClick = function () {
              window._hmt.push(['_trackEvent', '首页', 'PC端右侧广告位点击']);
          };

          _this.handleClose = function (e) {
              e.stopPropagation();
              var currentDate = (0, _moment2.default)(new Date()).format('YYYY-MM-DD');
              window.localStorage.setItem('sideAdCloseDate', currentDate);
              _this.setState({ isClose: true });
              window._hmt.push(['_trackEvent', '首页', 'PC端右侧广告位_关闭按钮点击']);
          };
      ...
      _createClass(SideBanner, [{
          ...
          value: function componentDidMount() {
              window._hmt.push(['_trackEvent', '首页', 'PC端右侧广告位_展现量']);
          }
      }, {
          key: 'render',
          value: function render() {
              ...
              var adData = this.props.adData;

              return _react2.default.createElement(
                  'div',
                  (_React$createElement = {
                      className: 'app-side-banner'
                  }, _defineProperty(_React$createElement, 'className', (0, _classnames2.default)('app-side-banner', {
                      'app-side-hide': isClose
                  })), _defineProperty(_React$createElement, 'style', { backgroundImage: 'url(' + adData.image + ')' }), _defineProperty(_React$createElement, 'onClick', this.handleClick), _React$createElement),
                  adData.url && _react2.default.createElement('a', {
                      className: 'app-side-link',
                      href: adData.url,
                      target: '_blank'
                  }),
                  +adData.show_ad === 1 && _react2.default.createElement('div', { className: 'app-side-icon' }),
                  +adData.show_close === 1 && _react2.default.createElement('div', {
  ...
  function initSideBanner(isShow) {
      if (sideFlag === isShow) {
          return;
      }
      ...
      sideFlag = isShow;
      if (sideFlag) {
          _fanyiUtil2.default.newFetch('/pc/config').then(function (res) {
              if (+res.errno === 0 && res.data && res.data.rightMid && res.data.rightMid.image) {
                  var todayDate = (0, _moment2.default)(new Date()).format('YYYY-MM-DD');
                  var closeDate = window.localStorage.getItem('sideAdCloseDate');
                  if (todayDate !== closeDate) {
                      _reactDom2.default.render(_react2.default.createElement(SideBanner, { adData: res.data.rightMid }), document.getElementById('sideBannerContainer'));
                  }
              }
          });
      } else {
          _reactDom2.default.render(null, document.getElementById('sideBannerContainer'));
      }
  }

});

;define("translation:widget/translate/output/adcards",function(n,t){"use strict";var a=n("translation:widget/translate/output/SideBanner/SideBanner.jsx");
t.updateSideBanner=function(n){a.initSideBanner(n)}});
...
;define("translation:widget/translate/output/output",function(t,e){"use strict";function a(t){return t&&t.__esModule?t:{"default":t}
}var n=t("translation:widget/redux/store"),o=a(n),r=t("translation:widget/translate/details/details"),i=a(r),s=t("translation:widget/redux/indexInfo/noteInfo"),u=t("translation:widget/common/environment"),l=t("translation:widget/common/third_party/template"),p=t("translation:widget/translate/output/fanyi"),d=(t("translation:widget/translate/output/adcards"),t("translation:widget/translate/output/mouseover")),c=t("translation:widget/translate/output/bottomBanner");
t("translation:widget/translate/output/NotePanel/NotePanel.jsx");var g=t("translation:widget/translate/sideNav/navSorter/navSorter"),v=$("#left-result-container"),f={result:null,init:function(){this.bindEvents()
},bindEvents:function(){var t=this;$(".translate-wrap").on("mouseover",".data-hover-tip",function(){d.isover({target:this})
}).on("mouseout",".data-hover-tip",function(){d.isout()}).on("copy",".output-bd",$.proxy(this.outputTextIsCopy,this)),c.bindEvents(),g.on("sortChange",function(){t.result&&t.checkResponse(t.result,!0)
...
},checkResponse:function(t,e){this.result=$.extend(!0,{},t||{});var a=t.res;return a.error?void(999===parseInt(a.error,10)?(this.clearOutputWrap(),p.normaltrans({data:{data:[{dst:a.query,src:a.query,result:[]}]}},t.query)):998===parseInt(a.error,10)?window.location.reload():997===parseInt(a.error,10)?alert("浏览器cookie功能被禁，请开启此功能"):this.showTimeout(a.errShowMsg)):void this.execResponse(t,e)
},showTimeout:function(t){t=t||"非常抱歉，翻译结果响应超时，请稍后再试!";var e={message:t},a=l("tplLongTextPrompt",e);$(".output-wrap").html(a)
},execResponse:function(t,e){var a=t.res,n=t.from,o=t.to,r=t.query,s=t.badCaseByForce;!e&&_hmt.push(["_trackEvent","首页","web端总共query数"]),a&&(this.clearOutputWrap(),a.trans_result&&p.normaltrans({data:a.trans_result}),i.default.init(a,n,o,r,s))
},clearOutputWrap:function(){u.set("hasDetail",!1),$(".textarea-bg-text").html(""),d.isout(),u.get("needLongtextTip")===!0?($(".output-wrap .output-mod").remove(),u.set("needLongtextTip",!1)):$(".output-wrap").empty().addClass("output-blank"),o.default.dispatch(s.clearNoteInfo()),v.empty()
}};$(function(){f.init()}),e.checkResponse=function(t){f.checkResponse(t)},e.clearOutputWrap=function(t){f.clearOutputWrap(t)
}});
...
;define("translation:widget/translate/input/uploader",function(t,e,o){"use strict";var i=t("translation:widget/common/third_party/webuploader/webuploader.fis"),p=(t("translation:widget/common/environment"),i.create({swf:"https://fanyi-cdn.cdn.bcebos.com/static/translation/widget/common/third_party/webuploader/Uploader_10d5704.swf",server:"https://fanyi-doc.baidu.com/doctrans/api/docupload",pick:{id:"#upload-btn-hidden",multiple:!1},resize:!1,fileVal:"uploadFile",auto:!1,withCredentials:!0,accept:[{title:"Images",extensions:"png,jpg,bmp,jpeg",mimeTypes:".png,.jpg,.bmp,.jpeg"},{title:"Documents",extensions:"doc,docx,ppt,pptx,xls,xlsx"+(window.common.pdfHit?",pdf":""),mimeTypes:".doc,.docx,.ppt,.pptx,.xls,.xlsx"+(window.common.pdfHit?",.pdf":"")}]}));
o.exports=p});
;define("translation:widget/translate/docTranslate/docTransUtil",function(e,t){"use strict";var n=e("translation:widget/translate/input/uploader"),a=e("translation:widget/common/environment"),r=e("translation:widget/translate/domain/domain"),o=$(".doc-trans-view-wrap .progress-bar"),i=$(".doc-trans-view-wrap"),s=i.find(".src-doc-padding-wrapper, .dst-doc-padding-wrapper"),d=i.find(".export-tip"),l=i.find(".doc-async-translating-tip"),c=$("#doc-view-iframe"),p=/^\/docViewMode\?name=(.+)&from=(\w+)&to=(\w+)&token=(\w+)$/,m={file:null,fileName:"",from:"",to:"",token:"",translatingParaIdxSet:new Set};
t.isSupportByDocTrans=function(e){var t=e.name;if("string"!=typeof t)return!1;var n=t.split(".");if(1===n.length)return!1;
var a=n[n.length-1].toLowerCase(),r=["doc","docx","xls","xlsx","ppt","pptx"];return window.common.pdfHit&&r.push("pdf"),-1!==r.indexOf(a)
},t.currTask=m;var f={percentage:0,uploadSuccess:function(){this.percentage=30,o.css("transform","scaleX("+this.percentage/100+")")
...
},complete:function(){this.percentage=100,o.css("transform","scaleX("+this.percentage/100+")")}};t.progress=f,t.clearDocTrans=function(e){r.show(),$("#main-outer").removeClass("doc-trans-mode").removeClass("doc-trans-view-mode"),$(".doc-trans-file").text(""),window.common.headerHit||!window.common.docHit||a.get("isInRtTransState")||0!==$("#baidu_translate_input").val().length||($("#upload-btn").show(),window.hasStatUploadBtnShow||(_hmt.push(["_trackEvent","首页","74_首页页面_上传文档按钮展示"]),window.hasStatUploadBtnShow=!0)),m.file&&n.cancelFile(m.file),m.fileName="",m.from="",m.to="",m.token="",m.translatingParaIdxSet.clear(),delete m.translatedSpanCounter,delete m.detectedFrom,delete m.detectedTo,delete m.isOverflow,delete m.isOriginalOverflow,delete m.url,delete m.isHtml;
var t=$(".doc-trans-view-wrap");t.find(".loading-container, .loading-err-container, .loading-exit-btn").removeAttr("style"),t.find(".export-doc-btn").removeClass("generating").prop("data-has-gen-link",!1),t.removeClass("loading viewing-html viewing-file"),d.hide(),l.hide(),$("#doc-specified-style").remove(),s.empty(),c.attr("src",""),f.reset(),e&&$("#upload-btn-hidden").find('input[type="file"]').click(),$(".footer").show()
...
},t.clearDocTransViewMode=function(){i.find(".file-name").text(""),i.find(".doc-view-from-lang").text(""),i.find(".doc-view-to-lang").text(""),i.find(".loading-container").removeAttr("style"),i.find(".loading-err-container").removeAttr("style"),i.removeClass("loading viewing-html viewing-file"),c.attr("src",""),f.reset(),$("#main-outer").removeClass("doc-trans-view-mode"),d.hide(),l.hide(),$(".footer").show()
...
;define("translation:widget/translate/input/clear",function(t,a){"use strict";var n=t("translation:widget/translate/input/textarea"),e=t("translation:widget/translate/input/soundicon"),r=t("translation:widget/translate/input/correct"),i=t("translation:widget/translate/input/prompt"),s=t("translation:widget/translate/output/output"),l=t("translation:widget/translate/output/bottomBanner"),o=t("translation:widget/translate/input/hash"),u=t("translation:widget/translate/input/inputSug"),c=t("translation:widget/translate/input/inputFavo"),d=t("translation:widget/translate/sideNav/sideNav"),p=t("translation:widget/translate/docTranslate/docTransUtil"),h=t("translation:widget/translate/output/adcards"),g={clearBtn:$(".textarea-clear-btn"),clearInput:function(a){i.hide(),e.hide(),c.resetBtn(),this.hideIcon(),r.hide(),n.empty(a),u.clearAndHideSug(),p.clearDocTrans(),t("translation:widget/translate/input/dataTransfer").clearInputImage();
var s=$(".translateio");if(s.hasClass("is-zoom-in")){$(".translateio").removeClass("is-zoom-in");try{$(window).trigger("resize")
}catch(l){}}$(".textarea-bg-text").html(""),h.updateSideBanner(!1)},clearOutput:function(){s.clearOutputWrap(),d.destroyNav(),this.setEmptyHash()
...
},setEmptyHash:function(){o.setHash({query:""})}};a.clearOutput=function(){g.clearOutput()},a.clearAll=function(t){g.clearAll(t)
},a.clearInputAndOutput=function(){g.clearInput(),s.clearOutputWrap()},a.show=function(){g.showIcon()},a.hide=function(){g.hideIcon()
},a.getElem=function(){return g.getElem()}});
              ...
              ['from', 'to'].forEach(function (langType) {
                  ...
                  if (typeof str === 'string' && str.length > 0) {
                      ...
                      if (Array.isArray(currOftenList) && currOftenList.length > 0) {
                          // 因为经常会上线下线语种，所以可能有的oftenList里面保存的语种已经被下线了，要验证是否可用
                          oftenList[langType] = currOftenList.filter(function (lang) {
                              return Boolean(langMap[lang]);
                          });
                          return;
                      }
                  }
...
o&&(t.from!==a||t.to!==n||t.query!==e)&&r(!1,e)}function r(a){var n=s.get(),e=n.from,r=n.to,o=u.getElem(),l=void 0;l=a?o.val():n.query,l.length>0?(l=l.replace(/\\r\\n/gi,"\n"),l=g.decodeHTML(l),/firefox/i.test(navigator.userAgent)===!0&&(l=l.replace(/%0A/gi,"\r\n"),l=unescape(l)),a||o.val(l),v.switchFontSize(),u.hasQuery(l),t("translation:widget/translate/input/dataTransfer").clearInputImage()):(T&&(i(),T=!1),f.clearInputAndOutput()),y.updateSideBanner(Boolean((""+l).trim())),u.focus();
var h=!1;e&&d.fromlangChange({lang:e,trans:h}),r&&c.tolangChange({lang:r,trans:h}),m.onTranslate()}function o(){var t=h.get("remote"),a=$.trim(t.query),n=$.trim(t.lang),e=/(.+)2(.+)/i,o=e.test(n)===!0,s=o?n.match(e)[1]:!1,g=o?"auto"!==n.match(e)[2]?n.match(e)[2]:window.common.locale:!1;
s&&g?(a.hasOwnProperty("length")&&0===a.length&&i(),l({from:s,to:g,query:a})):(T=!0,r())}function l(t){var a=t.from,n=t.to,e=t.query;
c.tolangChange({lang:n,trans:!1}),d.fromlangChange({lang:a,trans:!1}),e=g.decodeHTML(e),p.setHash({from:a,to:n,query:e}),encodeURIComponent(e).length>w.MAX_URL_COUNT&&(e=e.replace(/\\r\\n/gi,"\r\n"),u.getElem().val(e),r(!0))
}function i(){window.hasStatUploadBtnShow||(_hmt.push(["_trackEvent","首页","74_首页页面_上传文档按钮展示"]),window.hasStatUploadBtnShow=!0)
}var s=t("translation:widget/translate/common/hash"),g=t("translation:widget/common/util"),u=t("translation:widget/translate/input/textarea"),d=t("translation:widget/translate/translang/fromlang"),c=t("translation:widget/translate/translang/tolang"),m=t("translation:widget/translate/input/translate"),h=t("translation:widget/common/environment"),p=t("translation:widget/translate/input/hash"),w=t("translation:widget/common/config/trans"),f=t("translation:widget/translate/input/clear"),v=t("translation:widget/translate/input/fontSize"),y=t("translation:widget/translate/output/adcards"),T=!1;
...
;define("translation:widget/translate/docTranslate/docTranslate",function(t,n,e){"use strict";function a(t){return function(){var n=t.apply(this,arguments);
return new Promise(function(t,e){function a(r,o){try{var i=n[r](o),s=i.value}catch(c){return void e(c)}return i.done?void t(s):Promise.resolve(s).then(function(t){a("next",t)
},function(t){a("throw",t)})}return a("next")})}}function r(t){return 20>Q-t?3e3:1e4}function o(){var t=T.currTask,n=t.from,e=t.to,a=t.fileName;
b.find(".file-name").text(a);var r="auto"===n&&"auto"===e;b.find(".doc-view-from-lang").text(r?"中英互译":y[n].zhName),b.find(".doc-view-to-lang").text(r?"":y[e].zhName),b.find(".doc-view-lang-pair").toggleClass("auto",r),_.show(),C.hide(),b.addClass("loading"),j=null
...
E.text(e.title),O.text(e.content),_.hide(),C.show(),q.hide()}}function d(t){var n=t.isHtml,e=t.data,a=t.isOriginalOverflow;
if(n){G.text(T.currTask.fileName);var r=e.style,o=e.html,i=document.createElement("style");i.type="text/css",i.innerHTML=r,i.id="doc-specified-style",document.head.appendChild(i),I.html(o),R.html(o),I.find(".translated-span").each(function(t,n){var e=$(n);
e.text(e.attr("data-src-str"))}),j=$(".doc-whole-container .translated-span"),l(),a&&m(),window._hmt.push(["_trackEvent","首页","文档翻译_结果页展现，成功展示原文译文对照"]),h()
}else J.attr("src","https://view.officeapps.live.com/op/embed.aspx?src="+T.currTask.url)}function l(){$("#doc-fill-div").remove();
var t=I.height(),n=R.height(),e=Math.abs(t-n),a=n>t?I:R,r=$('<div style="height: '+e+'px" id="doc-fill-div"></div>');a.append(r)
}function u(t){t.stopPropagation(),U.hasClass("generating")||k()}function f(){return new Promise(function(t,n){$.ajax({url:"https://fanyi-doc.baidu.com/doctrans/api/querydownload?fileToken="+T.currTask.token,type:"GET",dataType:"json",cache:!1,xhrFields:{withCredentials:!0},success:function(n){t(n.errno)
},error:function(){n()}})})}function p(){var t="";try{t=decodeURIComponent(location.hash).replace(/^#/,"")}catch(n){}var e=T.viewModeRegExp.exec(t);
if(Array.isArray(e)){var a=w(e,5),r=a[1],i=a[2],s=a[3],l=a[4];Object.assign(T.currTask,{fileName:r,from:i,to:s,token:l}),o(),T.clearDocTransMode(),$("#main-outer").addClass("doc-trans-view-mode"),$(".footer").hide(),nn.uploadSuccess(),g().then(function(t){var n=t.isHtml,e=t.data;
if($("#main-outer").hasClass("doc-trans-view-mode")){var a=!1;if(n){var r=e.translatedSpanCounter,o=e.fromLang,i=e.toLang,s=e.isOverflow;
a=s,Object.assign(T.currTask,{translatedSpanCounter:r,detectedFrom:o,detectedTo:i,isOverflow:s,isOriginalOverflow:a})}else{var c=e;
Object.assign(T.currTask,{url:c})}Object.assign(T.currTask,{isHtml:n}),_.removeAttr("style"),C.removeAttr("style"),b.removeClass("loading").addClass("viewing-"+(n?"html":"file")),d({isHtml:n,data:e,isOriginalOverflow:a}),n&&(tn=!0,P.scrollTop(0))
}},c)}}function h(){setTimeout(function(){B=A.offset().top,K=A.height()},100)}function m(){[I,R].forEach(function(t){var n=t.find(".last-translated-sen"),e=n.offset().left-t.offset().left;
e>456&&n.addClass("show-tip-left")})}function v(t){return encodeURI(t).split(/%..|./).length-1}var w=function(){function t(t,n){var e=[],a=!0,r=!1,o=void 0;
try{for(var i,s=t[Symbol.iterator]();!(a=(i=s.next()).done)&&(e.push(i.value),!n||e.length!==n);a=!0);}catch(c){r=!0,o=c}finally{try{!a&&s["return"]&&s["return"]()
}finally{if(r)throw o}}return e}return function(n,e){if(Array.isArray(n))return n;if(Symbol.iterator in Object(n))return t(n,e);
throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),g=function(){var t=a(regeneratorRuntime.mark(function n(){var t,e,a,o;
return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:t=Q;case 1:if(!(t>0)){n.next=23;break}return e=r(t),n.next=5,i(e);
case 5:if($("#main-outer").hasClass("doc-trans-view-mode")){n.next=7;break}return n.abrupt("break",23);case 7:return n.next=9,s();
case 9:if(a=n.sent,0!==a.errno){n.next=19;break}return nn.complete(),n.next=14,i(600);case 14:return o=!0,"string"!=typeof a.data&&(o=!1),n.abrupt("return",{isHtml:o,data:o?JSON.parse(a.data):a.data.url});
case 19:t-=e/1e3,nn.add();case 21:n.next=1;break;case 23:throw{content:"非常抱歉，文档解析超时"};case 24:case"end":return n.stop()}},n,this)
}));return function(){return t.apply(this,arguments)}}(),k=function(){var t=a(regeneratorRuntime.mark(function n(){var t;
...
}}();t("translation:widget/common/third_party/jquery_scrollbar/jquery_scrollbar");var T=t("translation:widget/translate/docTranslate/docTransUtil"),x=t("translation:widget/translate/input/uploader"),y=t("translation:widget/common/config/langMap"),b=$(".doc-trans-view-wrap"),_=b.find(".loading-container"),C=b.find(".loading-err-container"),E=b.find(".err-title"),O=b.find(".err-content"),j=null,S=b.find(".doc-whole-container"),P=b.find(".src-doc-scroll-wrapper,.dst-doc-scroll-wrapper"),A=b.find(".src-doc-scroll-wrapper"),H=b.find(".dst-doc-scroll-wrapper"),I=b.find(".src-doc-padding-wrapper"),R=b.find(".dst-doc-padding-wrapper"),q=b.find(".loading-exit-btn"),M=b.find(".err-exit-btn"),N=b.find(".err-re-upload-btn"),D=b.find(".view-re-upload-btn"),U=b.find(".export-doc-btn"),F=b.find(".export-tip"),L=b.find(".no-tip-check"),z=b.find(".confirm-export-btn"),G=b.find(".view-file-name"),J=$("#doc-view-iframe"),V=b.find(".doc-async-translating-tip"),W=b.find(".go-back"),B=0,K=0,Q=window.common.domainHit||window.common.docLangHit?600:180,X=5e3,Y=2,Z=4,tn=!1;
$.fn.scrollEnd=function(t){var n=500;$(this).scroll(function(e){var a=$(this);return a.is(A)&&tn?void(tn=!1):(a.data("scrollTimeout")&&clearTimeout(a.data("scrollTimeout")),void a.data("scrollTimeout",setTimeout(function(){t(e),a.data("scrollTimeout",0)
},n)))})};var nn=T.progress;!function(){x.on("uploadSuccess",function(t,n){if(0===n.errno){var e=n.fileToken,a=T.currTask.file.name,r=T.currTask,o=r.from,i=r.to;
location.hash="/docViewMode?name="+encodeURIComponent(a)+"&from="+o+"&to="+i+"&token="+encodeURIComponent(e)}else c(10009===n.errno?{}:{content:"网络不给力，请稍后重试"})
}),x.on("uploadError",function(){c({content:"网络不给力，请稍后重试"})}),q.add(M).on("click",function(t){$(t.currentTarget).is(q)?window._hmt.push(["_trackEvent","首页","文档翻译_loading点击退出按钮"]):$(t.currentTarget).is(M)&&window._hmt.push(["_trackEvent","首页","文档翻译_文档解析失败点击退出按钮"]),location.hash="",T.clearDocTrans(!1)
}),N.add(D).on("click",function(t){$(t.currentTarget).is(D)?window._hmt.push(["_trackEvent","首页","76_首页页面_点击上传新文档按钮"]):$(t.currentTarget).is(N)&&window._hmt.push(["_trackEvent","首页","文档翻译_文档解析失败点击重新上传"]),location.hash="",T.clearDocTrans(!0)
}),U.on("click",u),F.on("click",function(t){return t.stopPropagation()}),L.on("click",function(){L.hasClass("checked")||window._hmt.push(["_trackEvent","首页","78_首页页面_选中导出提示中不再提示复选框"]),L.toggleClass("checked")
}),z.on("click",function(){window._hmt.push(["_trackEvent","首页","79_首页页面_点击导出提示中确认导出"]),L.hasClass("checked")&&localStorage.setItem("doNotTipExportOverflow","true"),F.hide(),k()
}),$(window).on("click",function(){"none"!==F.css("display")&&F.hide()}),W.on("click",function(){location.href=T.currTask.file?"/#/docTransMode":"/"
}),S.on("mouseenter","span.translated-span",function(t){var n=$(t.currentTarget),e=n.attr("data-span-idx"),a=null,r=null,o=null;
A.find(n).length>0?(a=A,r=H):(a=H,r=A),o=r.find(".translated-span[data-span-idx='"+e+"']"),n.add(o).addClass("hover");var i=B,s=i+r.height(),c=o.offset().top,d=c+o.height(),l=d-s;
if(l>0)r.is(A)&&(tn=!0),r.scrollTop(r.scrollTop()+l);else{var u=i-c;u>0&&(r.is(A)&&(tn=!0),r.scrollTop(r.scrollTop()-u))}}),S.on("mouseleave","span.translated-span",function(){j.removeClass("hover")
}),A.scrollbar(),H.scrollbar(),P.on("scroll",function(t){if(0!==j.length){var n=$(t.currentTarget);if(n.is(":hover")){var e=n.hasClass("src-doc-scroll-wrapper")?H:A,a=0,r=-1,o=n.find(".translated-span, .not-translated-para"),i=B,s=null,c=!0,d=0;
do{var l=o.eq(d++),u=l.offset().top-i;u>0&&(s=l,s.is(".not-translated-para")&&(c=!1),a=u,r=l.attr(c?"data-span-idx":"data-para-idx"))
}while(null===s&&d<o.length);if(-1!==r){var f=e.find("["+(c?"data-span-idx":"data-para-idx")+"='"+r+"']"),p=B+a-f.offset().top;
...
a.push(t),r.push(e),n&&T.currTask.translatingParaIdxSet.add(s),o.push(s),i+=v(e)+1}if($("#main-outer").hasClass("doc-trans-view-mode")&&T.currTask.isOverflow){var n=A.find(".not-translated-para"),e=null,a=[],r=[],o=[],i=0,s=0,c=null,d=!1,u=0;
...
});for(var e=r.length-n.length,i=0;e>i;i++)n.push(null);a.forEach(function(t,e){var a=H.find("[data-para-idx='"+o[e]+"']"),r=n[e],i=t.add(a);
if(i.removeClass("not-translated-para"),i.removeAttr("data-para-idx"),null===r)i.text("");else{var s=r.srcArray,c=r.dstArray,d=t,l=a;
s.forEach(function(t,n){var e=c[n],a=d.add(l);d.text(t),l.text(e),a.addClass("translated-span");var r=T.currTask.translatedSpanCounter++;
if(a.attr("data-span-idx",r),n<s.length-1){var o=d.clone(),i=l.clone();d.after(o),l.after(i),d=o,l=i}})}}),l(),0===A.find(".not-translated-para").length&&(T.currTask.isOverflow=!1),j=S.find(".translated-span"),V.hide()
...
},function(t){a("throw",t)})}return a("next")})}}function a(){M=!0}function o(t){M=!1,i(t)}function i(t){l(t),M||g.onRtTrans(t),D.updateManualTransBtn()
...
}function l(t){var n=$("#baidu_translate_input").val(),e=y[0];if(!("input"!==t.type&&("oninput"in e&&(!A||"keyup"!==t.type||8!==t.which&&46!==t.which)||"keyup"!==t.type||38===t.which||40===t.which||C.getCloseSugByEnter()||13===t.which&&C.getTranslatedByKeyDown()))){var a=T.switchFontSize();
a||t.triggerByOcr||M?C.clearAndHideSug():_.getByte(n)<=24&&C.loadSug(),P.updateSideBanner(Boolean((""+n).trim()))}if(S.hideWrap(),v.onHistoryInput(),b.onAdLinkInput(),n){if(13===t.which)return C.getCloseSugByEnter()&&C.setCloseSugByEnter(!1),void(C.getTranslatedByKeyDown()?C.setTranslatedByKeyDown(!1):h.onTranslate({transtype:"enter"}));
c.hasQuery(n),B.get("shouldClearPromptOnInput")&&(m.hide(),B.set("shouldClearPromptOnInput",!1))}else k.translateStopRepeat()||k.shutdownAudio(),f.clearAll(!1)
}var c=t("translation:widget/translate/input/textarea"),u=t("translation:widget/translate/input/soundicon"),d=t("translation:widget/translate/input/sound"),p=t("translation:widget/translate/input/correct"),g=t("translation:widget/translate/input/rttrans"),m=t("translation:widget/translate/input/prompt"),h=t("translation:widget/translate/input/translate"),w=t("translation:widget/translate/input/inputSoungUrlHandler"),f=t("translation:widget/translate/input/clear"),v=t("translation:widget/translate/history/history"),y=c.getElem(),k=t("translation:widget/translate/details/dictionary/simplemeans"),T=t("translation:widget/translate/input/fontSize"),C=t("translation:widget/translate/input/inputSug"),_=t("translation:widget/common/string"),S=t("translation:widget/translate/zonedword/wordWrap"),b=t("translation:widget/translate/details/adLink/adLink"),E=t("translation:widget/translate/input/dataTransfer"),x=t("translation:widget/translate/input/drag"),D=t("translation:widget/translate/translang/manualTrans"),B=t("translation:widget/common/environment"),R=t("translation:widget/translate/input/uploader"),I=t("translation:widget/translate/docTranslate/docTransUtil"),L=t("translation:widget/login/login"),z=t("translation:widget/translate/domain/domain"),P=t("translation:widget/translate/output/adcards"),A="oninput"in y[0]&&"documentMode"in document&&9===document.documentMode,M=!1;
...
var n=$(this).attr("data-lang");m.onPrompt(n),_hmt.push(["_trackEvent","首页","web端点击语种检测提示"])}).on("click",".open-from-lang",function(n){n.stopPropagation();
...
(n.hasClass("input-wrap")||n.hasClass("textarea-wrap"))&&(t.preventDefault(),c.focus())}),x.bindEvent();var h=$("#image-holder"),v=$("#preview-img"),T=$(".translateio");
h.on("click",function(){if(v.is(":hidden")){var t=v.get(0),n=window.URL||window.webkitURL;t.onload=function(){var t=this.src;
setTimeout(function(){n.revokeObjectURL(t)},1e3),T.addClass("is-zoom-in");try{$(window).trigger("resize")}catch(e){}},t.src=n.createObjectURL(h.data("file")),_hmt.push(["_trackEvent","首页","56_首页页面_点击放大缩略图的次数"])
...
break}if(window.common.docTransWithoutLogin){a.next=4;break}return a.next=4,L.ensureUserLoginAsync();case 4:if(e=window.common.docLangHit?30:10,!(t.size>1024*e*1024)){a.next=10;
...
});var C=localStorage.getItem("hasShowDocTipV2");C||($("#upload-btn").addClass("with-first-tip"),$(window).on("click.hideDocTip",function(){$("#upload-btn").removeClass("with-first-tip"),$(window).off("click.hideDocTip"),localStorage.setItem("hasShowDocTipV2","true")
})),$(window).on("click.stopSound",function(t){var n=$(t.target);n.hasClass("icon-sound")||n.hasClass("op-sound")||n.hasClass("sound-btn")||n.hasClass("icon-repeat")||n.hasClass("op-repeat")||n.hasClass("usecase-sound")||(BTPM.doPause(),k.shutdownRepeat(),$(".op-sound").removeClass("op-sound-active"))
...
break}}}}else for(var g=a.length-1;g>=0;g--){var w=a.item(g);if(w.type.startsWith("image/")){i=!0,o=w;break}if(E.isSupportByDocTrans(w)&&window.common.docHit){s=!0,u=w;
break}if("drop"===e&&window.common.docHit&&!E.isUrlFileInEdge(w)){E.logWrongFileFormat(w),alert("目前仅支持 "+(window.common.pdfHit?"pdf、":"")+"docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
...
},!1),o.open("POST","/getocr"),o.send(i)}).catch(function(t){return alert(t),g(!1),Promise.reject()})}function u(t){return new Promise(function(e,n){if(t.size>F)return _hmt.push(["_trackEvent","首页","57_首页页面_浏览器弹窗提示_图片大小超过10M"]),void n("您上传的图片已超过"+H+"M，请重新上传");
...
return U?t=!0:Date.now()-T<P?t=!0:T=Date.now(),t&&(_hmt.push(["_trackEvent","首页","57_首页页面_浏览器弹窗提示_您的操作过于频繁 请稍候再试"]),alert("上传图片过于频繁，请稍后再试")),t
}function l(t){return t>=15&&4096>=t}function d(t){return D.includes(t)||"auto"===t?!0:(alert("当前语言不支持图片识别，请选择语言"),y.fromBtnClicked(),!1)
}function p(e,n){if(j.removeClass("with-loading-ocr-tip"),0!==e.errno||0===e.errno&&0===e.data.src.length){t("translation:widget/translate/input/clear").show(),v.set("shouldClearPromptOnInput",!0);
...
}else{var a=e.data.src.join(""),i=e.data.from,o=w.getElem();o.val(a),v.set("isProcessOcrResult",!0);var s=t("translation:widget/translate/input/events");
...
}}function m(){C.css("background-image","none"),j.removeClass("with-image"),C.data("file",null)}function f(){return $(".trans-input-wrap").hasClass("with-image")&&$("#image-holder").data("file")&&!$("#baidu_translate_input").val()?(h($("#image-holder").data("file"),!0),!1):!0
...
case 22:case"end":return n.stop()}},n,this)}));return function(){return e.apply(this,arguments)}}(),w=t("translation:widget/translate/input/textarea"),v=t("translation:widget/common/environment"),k=t("translation:widget/common/third_party/image-compressor"),x=t("translation:widget/common/third_party/bowser"),b=t("translation:widget/translate/input/uploader"),E=t("translation:widget/translate/docTranslate/docTransUtil"),y=t("translation:widget/translate/translang/langPanelContainer.jsx"),L=new k,j=$(".trans-input-wrap"),C=$("#image-holder"),R=!1,I=!1,T=0,U=!1,H=window.common.docLangHit?30:10,F=1048576*H,O=3,P=1e3*O,D=v.get("ocrLangList"),B=["png","jpg","bmp","jpeg"];
...
;define("translation:widget/translate/input/translate",function(t,a){"use strict";function e(t){return t&&t.__esModule?t:{"default":t}
}function n(t){var a="web_error_report",e=JSON.stringify({information:t});o.default.newFetch("/track",{key:a,params:e,sign:i.default("key"+a+"params"+e+a)},"POST",void 0,!0).catch(function(){})
}var r=t("translation:widget/common/fanyiUtil"),o=e(r),s=t("translation:widget/common/third_party/md5"),i=e(s),l=t("translation:widget/translate/input/prompt"),u=t("translation:widget/translate/input/textarea"),g=t("translation:widget/common/util"),d=t("translation:widget/translate/output/output"),c=t("translation:widget/common/config/trans"),m=t("translation:widget/translate/input/processlang"),f=t("translation:widget/common/string"),p=t("translation:widget/translate/input/soundicon"),y=t("translation:widget/translate/input/hash"),h=t("translation:widget/common/environment"),w=t("translation:widget/translate/input/longtext"),v=t("translation:widget/translate/details/dictionary/simplemeans"),_=t("translation:widget/translate/history/history"),L=t("translation:widget/translate/input/pGrab"),T=t("translation:widget/translate/details/adLink/adLink"),R=t("translation:widget/translate/domain/domain"),b={onTrans:function(t){v.translateStopRepeat()||v.shutdownAudio();
var a=(u.getElem(),u.getVal()),e=this,n=t&&t.transtype;if(g.isUrl(a))return void this.translateWebPage(a);if(this.isQueryValid(a)){var r=a;
r.length>50&&(r=f.cutByByte(r,0,150).replace(/[\uD800-\uDBFF]$/,""));var o={query:r};$.ajax({url:"/langdetect",type:"POST",data:o,success:function(t){0===t.error&&t.lan?e.langIsDeteced(t.lan,a,n):e.reponseQuery(a)
}})}},isQueryValid:function(t){return t?!0:!1},processQuery:function(t){var a=t;if(t.length>c.MAX_QUERY_COUNT){h.set("needLongtextTip",!0);
var e=t;a=t.substr(0,5e3),e=t.substr(0,3),w.showTip({query:e})}return a},langIsDeteced:function(a,e,r,o){if(null!==a){var s=$(".select-from-language .language-selected").attr("data-lang"),i=$(".select-to-language .language-selected").attr("data-lang"),u="1"===$(".select-from-language .language-selected").attr("data-detected"),g=!1;
h.get("langChangedByUser")&&a===i&&(g=!0);var d=null;if(o&&!h.get("fromLangIsAuto")&&s!==a?d=m.processOcrLang(a,s,i):(l.show(a,s),d=m.getLang(a,s,i)),"LAN-UNKNOWN"===a&&("auto"===s||u)){var c=t("translation:widget/translate/input/clear");
return void c.clearOutput()}p.show(),$("body").trigger("updateFromTo.domainTrans",d);var f=this,e=this.processQuery(e),y={from:d.fromLang,to:d.toLang,query:e,transtype:r,simple_means_flag:3,sign:L(e),token:window.common.token,domain:R.getCurDomain()};
R.log(),this.translateXHR&&4!==this.translateXHR.readyState&&this.translateXHR.abort(),this.translateXHR=$.ajax({type:"POST",url:"/v2transapi?from="+encodeURIComponent(d.fromLang)+"&to="+encodeURIComponent(d.toLang),cache:!1,data:y,error:function(t,a,r){n(t.status+" "+a+" "+r+" "+d.fromLang+" "+d.toLang+" "+e)
}}).done(function(t){h.set("isInRtTransState",!0),f.translateSuccess(t,d.fromLang,d.toLang,e,g)})}},translateWebPage:function(t){var a="/";
...
},textareaFocus:function(){u.focus()},translateSuccess:function(t,a,e,r,o){return u.getVal()?(r&&_.add(a,e,$.trim(r)),_.hideHistory(),T.hide(),t.error?n("errno: "+t.error+" "+a+" "+e+" "+r):t.trans_result&&Array.isArray(t.trans_result.data)&&0!==t.trans_result.data.length||n("empty result "+a+" "+e+" "+r),d.checkResponse({res:t,from:a,to:e,query:r,badCaseByForce:o}),void y.setHash({query:r})):void h.set("isInRtTransState",!1)
},reponseQuery:function(){}};a.onTranslate=function(t){b.onTrans(t)},a.translateAfterOcr=function(t,a){_hmt.push(["_trackEvent","首页","59_首页页面_翻译query量_图片"]),b.langIsDeteced(t,a,void 0,!0)
}});
...
}function e(){O.find(".domain-trans-toast-text").text("已切换到"+L[M]+(M===h.COMMON?"":"领域")),$("body").append(O),null!=N&&clearTimeout(N),N=setTimeout(function(){return i()
},2e3)}function i(){O.remove().find(".domain-trans-toast-text").text(""),null!=N&&(clearTimeout(N),N=null)}function r(){window._hmt.push(["_trackEvent","首页","99_首页页面_"+L[M]+"领域发起翻译次数"])
}function d(){return M}function s(a){var n=a.domain,t=a.fromLang,o=a.toLang;switch(n){case h.COMMON:return!1;case h.FINANCE:case h.BM:var e="auto"!==t&&"zh"!==t&&"en"!==t,i="zh"!==o&&"en"!==o;
return e||i;case h.NOVEL:case h.ET:case h.WCM:var r=void 0,d=void 0;return"auto"===t?(r=!1,d="en"!==o&&"zh"!==o):"zh"===t?(r=!1,d="en"!==o):(r=!0,d=!0),r||d;
case h.MILITARY:return["en","ru","jp","kor","hi","fra","de","spa","vie"].includes(t)&&"zh"===o?!1:!0}}function m(){C.find("[data-domain-value]").removeClass("active").end().find('[data-domain-value="'+M+'"]').addClass("active"),b.find(".domain-trans-bottom .active").length>0&&b.find(".domain-trans-bottom").append(b.find(".domain-trans-top .domain-trans-item-wrapper").eq(1)).end().find(".domain-trans-top").append(b.find(".domain-trans-bottom .active").parent()),w.find(".domain-trans-bottom .active").length>0&&w.find(".domain-trans-bottom").append(w.find(".domain-trans-top .domain-trans-item-wrapper").eq(0)).end().find(".domain-trans-top").append(w.find(".domain-trans-bottom .active").parent()),b.toggleClass("domain-trans-hot",b.find(".domain-trans-top .domain-trans-bm").length>0),w.toggleClass("domain-trans-hot",w.find(".domain-trans-top .domain-trans-bm").length>0),$(".output-wrap").attr("data-domain-value",M),e()
}function l(a){var n=a.fromLang,t=a.toLang;Object.values(h).forEach(function(a){var o=s({domain:a,fromLang:n,toLang:t});C.find('[data-domain-value="'+a+'"]').toggleClass("disable",o)
})}function c(){$("body").on("updateFromTo.domainTrans",function(a,n){var t=void 0,o=void 0;if(null==n?(t=$(".select-from-language .language-selected").attr("data-lang"),o=$(".select-to-language .language-selected").attr("data-lang")):(t=n.fromLang,o=n.toLang),s({domain:M,fromLang:t,toLang:o})){M=h.COMMON;
var e=C.find(".domain-trans-common"),i=C.find(".domain-trans-common .domain-trans-item-tip span");e.addClass("reset"),i.text(s({domain:h.BM,fromLang:t,toLang:o})?"当前语种仅支持通用领域":"当前语种仅支持通用领域、生物医药领域"),setTimeout(function(){e.removeClass("reset")
},3e3),m()}l({fromLang:t,toLang:o})}).on("click",".domain-trans-item",function(){var a=$(this),n=String(a.data("domainValue"));
M===n||a.hasClass("disable")||(M=n,m(),v.onTranslate({transtype:"translang"}))}).on("click",".domain-trans-tip-close",function(){C.find(".domain-trans-tip").hide()
}).on("click",".domain-trans-toast-close",function(){return i()})}function u(){"16122020"!==window.common.sid&&$(".domain-trans-military").parent(".domain-trans-item-wrapper").remove(),c();
var a=$(".select-from-language .language-selected").attr("data-lang"),n=$(".select-to-language .language-selected").attr("data-lang");
l({fromLang:a,toLang:n})}function f(){C.show(),$(".output-wrap").attr("data-domain-value",M)}function g(){C.hide(),$(".output-wrap").attr("data-domain-value","")
}var p,v=a("translation:widget/translate/input/translate"),h={COMMON:"common",BM:"medicine",ET:"electronics",WCM:"mechanics",NOVEL:"novel",FINANCE:"finance",MILITARY:"military"},L=(p={},o(p,h.COMMON,"通用领域"),o(p,h.BM,"生物医药"),o(p,h.ET,"电子科技"),o(p,h.WCM,"水利机械"),o(p,h.NOVEL,"网络文学"),o(p,h.FINANCE,"金融"),o(p,h.MILITARY,"军事"),p),M=h.COMMON,C=$(".domain-trans-wrapper"),b=$(".domain-trans-large"),w=$(".domain-trans-small"),O=$(['<div class="domain-trans-toast">','<div class="domain-trans-toast-text"></div>','<div class="domain-trans-toast-close"></div>',"</div>"].join("")),N=null;
t.exports={getCurDomain:d,log:r,show:f,hide:g},$(function(){u()})});
;define("translation:widget/translate/details/keywords/keywords",function(t,e){"use strict";function n(t){return t&&t.__esModule?t:{"default":t}
}var i=t("translation:widget/translate/favo/favo"),o=n(i),a=t("translation:widget/translate/input/pGrab"),r=n(a),d=t("translation:widget/translate/domain/domain"),s=n(d),l=t("translation:widget/translate/details/details"),c=n(l),u=t("translation:widget/common/third_party/template"),h=t("translation:widget/common/environment"),f=$("#left-result-container"),m={build:function(t){var e=1===parseInt(h.get("firstModuleId"),10),n=t.data.splice(0,10),i=t.from,a=t.to,r=!1,d={};
"zh"===i&&"en"===a?(r=!0,_hmt.push(["_trackEvent","首页","Web中英方向重点词汇卡片展现次数"]),d.direction="zh2en"):(_hmt.push(["_trackEvent","首页","Web英中方向重点词汇卡片展现次数"]),d.direction="en2zh"),$.each(n,function(t,e){e.href="/#"+i+"/"+a+"/"+encodeURIComponent(e.word)
}),d.dataArray=n,d.meanNeedHighlight=r,d.isFirstCard=e;var s=u("tpl-keywords",d);f.append(s),n.forEach(function(t,e){var n=t.word,r=t.means,d=new o.default({pos:"keyword",target:$(".keywords-container .keywords-content[data-key-word-idx='"+e+"'] .op-favo")[0]});
d.init({query:n,from:i,to:a,fanyiDst:r.join("; ")})})},init:function(){this.bindEvent()},bindEvent:function(){var t=this;
$(".translate-wrap").on("click",".keywords-word",function(){var t=$(this),e=t.attr("data-direction"),n=t.text();_hmt.push("zh2en"===e?["_trackEvent","首页","Web中英方向重点词汇二次翻译次数"]:["_trackEvent","首页","Web英中方向重点词汇二次翻译次数"]);
var i=e.split("2")[0],o=e.split("2")[1],a={from:i,to:o,query:n,transtype:"enter",simple_means_flag:3,sign:r.default(n),token:window.common.token,domain:s.default.getCurDomain()};
$.ajax({type:"POST",url:"/v2transapi?from="+encodeURIComponent(i)+"&to="+encodeURIComponent(o),cache:!1,data:a}).done(function(e){$(".keywords-word").removeClass("selected"),t.addClass("selected"),f.children(":not(.keywords-outter, .keywords-outter-notfirst)").remove(),c.default.init(e,i,o,n,!1,!0)
})}).on("dblclick.keywords",".keywords-inner .highlight",function(){t.getHighlightQueryAndSave($(this))}).on("mouseover.keywords",".keywords-inner .highlight",function(){_hmt.push(["_trackEvent","首页","Web重点词汇卡片highlight次数"])
})},getHighlightQueryAndSave:function(t){var e=t.text(),n="keywords";h.set("dbClickHighlightZone",{query:$.trim(e),area:n})
}};$(function(){m.init()}),e.build=function(t){m.build(t)}});
;define("translation:widget/translate/details/sample/sample",function(e,t){"use strict";var a,n,l,i,s=e("translation:widget/common/third_party/template"),o=e("translation:widget/translate/details/dictionary/simplemeans"),r=e("translation:widget/common/soundURIGenerator"),u=e("translation:widget/common/environment"),g=$("#left-result-container"),d=["《柯林斯高阶英汉双解学习词典》","《汉英大词典》","百度翻译例句库","《牛津高阶英汉双解词典》","《外研社英语同义词辨析词典》","中考真题","高考真题","四级真题","六级真题"],p=new RegExp(d.join("|")),c=void 0,m={buildSample:function(e){var t=e.data;
a=e.from,n=e.to,i=e.query,c=e.badCaseByForce;var o={};if(o.tplData={},o.tplData.to_lang=n,t["double"]=t["double"].replace(/\\'/g,"'"),t.single=t.single.replace(/\\'/g,"'"),t["double"]=t["double"].replace(/[‘|’]/g,"'"),t.single=t.single.replace(/[‘|’]/g,"'"),t["double"]){var r=this.getDoubleSample(t["double"],c);
o.tplData["double"]=r["double"],o.tplData.badCaseByForce=c,o.tplData.senData=r.senData,l=o}if(t.single){t.single=$.parseJSON(t.single),t.senData2=[];
for(var u=0,d=t.single.length;d>u;u++){var p,m="";"zh"===n?p=t.single[u][0]:"en"===n&&(p=t.single[u][1]);for(var h=0,v=p.length;v>h;h++)m+=p[h][0],p[h][3]&&(m+=p[h][3]);
m=encodeURIComponent(m),t.senData2[u]=m;var f=t.single[u][1];if(/^http\:\/\//.test(f)){f=f.replace(/^http\:\/\//,"");var b=f.indexOf("/");
t.single[u][2]=b>0?f.substr(0,b):f}else t.single[u][2]=t.single[u][1],t.single[u][1]="#"}o.tplData.single=t.single,o.tplData.senData2=t.senData2
}if(t.tag&&t.tag instanceof Array){var S=t.tag.length;S&&S>1&&(o.tplData.tag=t.tag,_hmt.push(["_trackEvent","首页","web端双语例句子TAB出现"]))
}var D=s("tplSample",o);g.append(D)},getDoubleSample:function(e,t){var a={};a["double"]=$.parseJSON(e),a.senData=[];for(var l=!0,i=0,s=a["double"].length;s>i;i++){var o,r="";
!t&&"zh"===n||t&&"en"===n?o=a["double"][i][0]:(!t&&"en"===n||t&&"zh"===n)&&(o=a["double"][i][1]);for(var u=0,g=o.length;g>u;u++)r+=o[u][0],o[u][4]&&(r+=o[u][4]);
r=encodeURIComponent(r),a.senData[i]=r,l&&!p.test(a["double"][i][2])&&(a["double"][i].isFirstNetSt=!0,l=!1);var d=a["double"][i][2];
if(/^https?\:\/\//.test(d)){d=d.replace(/^https?\:\/\//,"");var c=d.indexOf("/");a["double"][i][3]=c>0?d.substr(0,c):d}else a["double"][i][3]=a["double"][i][2],a["double"][i][2]="#"
}return a},bindEvents:function(){var e=this;$(".translate-wrap").on("click",".item-sample .op-sound",function(){e.clickSound({target:this})
}).on("mouseenter",".item-sample .op-sound",function(){e.mouseOverSound({target:this})}).on("mouseleave",".item-sample .op-sound",function(){e.mouseOutSound()
}).on("mouseover",".sample-wrap span[high-light-id]",function(){e.mouseOverHighlight({target:this})}).on("mouseout",".sample-wrap span[high-light-id]",function(){e.mouseOutHighlight({target:this})
}).on("click",".sample-tagitem",function(){e.clickTagItem({target:this})}).on("dblclick.sample",".sample-wrap .sample-source, .sample-wrap .sample-target",function(){e.getHighlightQueryAndSave($(this))
})},clickSound:function(e){o.judgeStopRepeat(),this.timer&&clearTimeout(this.timer);var t=$(e.target),a=r.generateURI({lan:t.attr("data-sound-lan"),text:t.attr("data-sound-text")});
BTPM.setUrl(a);var n;t.addClass("op-sound-active"),n&&clearTimeout(n),n=setTimeout(function(){t.removeClass("op-sound-active")
},2e3),_hmt.push(["_trackEvent","首页","web端点击双语例句TTS"])},mouseOverSound:function(e){if("hover"===u.get("soundTriggerMode")){var t=this;
this.timer=setTimeout(function(){t.clickSound({target:e.target})},500)}},mouseOutSound:function(){clearTimeout(this.timer)
},mouseOverHighlight:function(e){var t=$(e.target),a=t.attr("high-light-id");if(""!==a){var n=t.parent().parent();n.find("span").each(function(){$(this).attr("high-light-id")===a&&$(this).addClass("high-light-bg")
})}},mouseOutHighlight:function(e){var t=$(e.target),a=t.parent().parent();a.find("span").removeClass("high-light-bg")},clickTagItem:function(e){var t=$(e.target);
if(!t.hasClass("sample-current")){t.addClass("sample-current").siblings().removeClass("sample-current");var a=$(window).scrollTop();
if(t.hasClass("sample-all")){var n=s("tplSampleTagcont",l);g.find(".double-sample").html(n);var i=u.get("collapse");i.setSampleCollapse(!0),window.scrollTo(0,a)
}else{var o=t.text();this.getTagSampleDataAndRender({tag:o},a)}_hmt.push(["_trackEvent","首页","web端点击双语例句子TAB"])}},getTagSampleDataAndRender:function(e,t){var l=this,o={from:a,to:n,query:i,stTag:e.tag};
$.ajax({url:"/transextra",data:o,type:"POST",dataType:"JSON",success:function(e){if(0===e.errno&&e.data&&e.data.st){var a=e.data.st,i={};
...
r.setSampleCollapse(!0),window.scrollTo(0,t)}}})},getHighlightQueryAndSave:function(e){var t="";$.each(e.find(".high-light-bg"),function(e,a){t+=$(a).text()
});var a="sample";u.set("dbClickHighlightZone",{query:$.trim(t),area:a})}};$(function(){m.bindEvents()}),t.buildSample=function(e){m.buildSample(e)
}});
...
}var t=D.find(function(e){return"festivalLink"!==e&&"adLink"!==e});s.set("firstModuleId",parseInt(Object.keys(q).find(function(e){return q[e]===t
}),10))}();var J=a.dict_result;D.forEach(function(e){switch(e){case"translator":n.build(a.simworks);break;case"keyWord":u.build({data:a.trans_result.keywords,from:t,to:S});
break;case"simpleMeaning":d.buildSimpleMeans({data:C,to:S,baikeImgUrl:E,queryExplainVideo:I});break;case"festivalLink":l.buildFestivalLink();
break;case"adLink":r.build(F);break;case"oxford":h.init(J.oxford);break;case"collins":g.buildCollins({data:J.collins});break;
case"en2en":o.buildEdict({data:J.edict});break;case"zh2en":w.buildDict({data:J.synthesize_means});break;case"zh2zh":c.buildZdict({data:J.zdict});
break;case"illSen":y.buildSample({data:a.liju_result,from:t,to:S,query:j,badCaseByForce:O});break;case"wordColl":_.buildGeneral({data:J.general_knowledge});
break;case"webMeaning":p.buildWebMeans({data:J});break;case"synonym":v.buildSynonym({data:J.synonym});break;case"rootsaffixes":z.buildRootsaffixes({data:J.rootsaffixes});
break;case"usecase":L.buildUsecase({data:J.usecase});break;case"sanyms":x.buildSanyms({data:J.sanyms});break;case"etym":M.buildEtym({data:J.etym})
}});var R=!1;for(var U in B)R=R||B[U];N||(R&&("en"===t&&"zh"===S&&j.length<417&&i.build(),s.set("hasDetail",!0)),b.init({from:t,to:S,query:j,dictJSON:W})),"en"===t&&"zh"===S||"zh"===t&&"en"===S?(k.genCollapse(),f.genNav(N?!1:!0)):f.destroyNav()
}Object.defineProperty(a,"__esModule",{value:!0});{var s=e("translation:widget/common/environment"),n=e("translation:widget/translate/details/translator/translator"),i=e("translation:widget/translate/details/appRead/appRead"),l=e("translation:widget/translate/details/festivalLink/festivalLink"),r=e("translation:widget/translate/details/adLink/adLink"),d=e("translation:widget/translate/details/dictionary/simplemeans"),o=e("translation:widget/translate/details/edict/edict"),c=e("translation:widget/translate/details/zdict/zdict"),u=e("translation:widget/translate/details/keywords/keywords"),m=e("translation:widget/translate/output/bottomBanner"),b=e("translation:widget/translate/input/inputFavo"),f=e("translation:widget/translate/sideNav/sideNav"),k=e("translation:widget/translate/details/collapse/collapse"),y=e("translation:widget/translate/details/sample/sample"),g=e("translation:widget/translate/details/collins/collins"),w=e("translation:widget/translate/details/zhenDict/zhenDict"),_=e("translation:widget/translate/details/general/general"),p=e("translation:widget/translate/details/webMeans/webMeans"),h=e("translation:widget/translate/details/oxford/oxford"),v=e("translation:widget/translate/details/synonym/synonym"),z=e("translation:widget/translate/details/rootsaffixes/rootsaffixes"),L=e("translation:widget/translate/details/usecase/usecase"),x=e("translation:widget/translate/details/sanyms/sanyms"),M=e("translation:widget/translate/details/etym/etym");
$("#left-result-container")}a.default={init:t}});
...
f.removeClass("selected"),f.filter('[data-dir="'+t+'"]').addClass("selected");var e="auto2auto"===t;l.toggleClass("auto",e),e?l.find(".from-doc-lang").text("中英互译"):(l.find(".from-doc-lang").text(s[n].zhName),l.find(".to-doc-lang").text(s[r].zhName)),d.removeClass("open"),m.from=n,m.to=r
}function a(t){return{from:t.split("2")[0],to:t.split("2")[1]}}function n(){c.removeClass("guiding"),localStorage.setItem("docTransLangGuideFlag","true")
...
}return t},e=t("translation:widget/translate/input/uploader"),i=t("translation:widget/translate/docTranslate/docTransUtil"),s=t("translation:widget/common/config/langMap"),c=$(".doc-trans-operation"),d=$(".doc-trans-dir"),l=d.find(".curr-doc-dir"),u=d.find(".doc-lang-select"),f=u.find(".doc-lang-pair"),g=u.find(".know-btn"),m={from:"auto",to:"auto"};
!function(){var a=localStorage.getItem("docTransDir");a&&o(a),$(".doc-trans-btn").on("click",function(){window.common.docSid?e.option("formData",r({},m,{sid:window.common.docSid})):e.option("formData",m),e.upload(i.currTask.file),Object.assign(i.currTask,m);
var o=t("translation:widget/translate/docTranslate/docTranslate");o.loading(),$("#main-outer").removeClass("doc-trans-mode").addClass("doc-trans-view-mode"),$(".footer").hide(),window._hmt.push(["_trackEvent","首页","80_首页页面_点击文档翻译的翻译按钮"]),"auto"===m.from&&"auto"===m.to&&window._hmt.push(["_trackEvent","首页","81_首页页面_点击文档翻译的翻译按钮时语言方向为中英互译"])
}),l.on("click",function(){d.toggleClass("open"),n()}),f.on("click",function(t){var a=$(t.currentTarget).attr("data-dir");
localStorage.setItem("docTransDir",a),o(a),n()}),g.on("click",function(){n(),d.removeClass("open")}),$("body").on("click",function(t){var o=$(t.target);
0!==d.find(o).length||o.is(d)?window._hmt.push(["_trackEvent","首页","文档翻译_点击语言设置框"]):d.removeClass("open")})}()});
;define("translation:widget/translate/input/indexlog",function(n){"use strict";var t=n("translation:widget/translate/common/hash"),e=(n("translation:widget/common/util"),{init:function(){this.sendIndexLog(),this.bannerIndexDisplayLog()
},sendIndexLog:function(){var n=this.getQueryString("aldtype");_hmt.push(["_trackEvent","首页","web端PV"]);var t=parseInt(n,10);
...
}},getQueryString:function(n){var t=new RegExp("(^|&)"+n+"=([^&]*)(&|$)","i"),e=window.location.search.substring(1).match(t);
return null!=e?e[2]:null}});$(function(){e.init()})});
...
t("translation:widget/common/flash"),$(function(){n.init(),a.init(),t("translation:widget/translate/input/autoRequest").compatibleTrans(),window.common.docHit&&!window.common.headerHit?$("#upload-btn").show():$("#upload-btn").hide()
...
}function i(){$(window).on("resize",o),c.on("click",a),s.on("click",function(){_hmt.push(["_trackEvent","首页","96_首页页面_右侧悬浮按钮点击"]),window.open("https://fanyi.baidu.com/appdownload/download.html?tab=app&appchannel=webright")
})}function a(n){n.preventDefault(),$("html, body").animate({scrollTop:0},250),_hmt.push(["_trackEvent","index","web端回到顶部按钮点击"])
}n("translation:widget/common/util");t.init=function(){o(),i()};var e=$(".extra-wrap"),c=e.find(".backtotop-btn"),s=e.find(".sideQrContainer");
$(window).on("scroll",function(){var n=$(document).scrollTop();n>0?(c.css("display","block"),s.css("display","block"),_hmt.push(["_trackEvent","首页","95_首页页面_右侧悬浮按钮展现"])):(c.hide(),s.hide())
})});
;define("translation:widget/footer/follow/follow",function(o,t){"use strict";function i(){$("#follow-btns").on("click",a),$("#fdialog-wrap").on("click",l)
}function a(o){var t=$(o.target),i=t.attr("data-pos");if("0"!==i){var a=t.attr("title");if("undefined"!=typeof i){3!==+i&&n(+i);
var l="Web翻译"+a+"点击";_hmt.push(["_trackEvent","follow icons",l])}}}function n(o){$(".fdialog-cont").addClass("hide"),$(".cont-"+o).removeClass("hide"),$("#follow-dialog").removeClass("hide")
}function l(o){var t=o.target;return t===this||t===$("#fdialog-close").get(0)?($("#follow-dialog").addClass("hide"),o.stopPropagation(),!1):void 0
}t.init=function(){i()}});
;define('translation:widget/footer/Products/Products.jsx', function(require, exports, module) {
  ...
  var Products = function (_React$PureComponent) {
      ...
      function Products(props) {
          ...
          _this.hanldeClick = function (title) {
              window._hmt.push(['_trackEvent', '首页', 'PC\u5E95\u90E8_\u91D1\u521A\u4F4D_' + title + '\u70B9\u51FB']);
          };
          ...
          _this.state = {
              productList: [{
                  ...
                  title: '百度翻译桌面端',
                  desc: '轻·快的多语种翻译工具',
                  downloadUrl: 'https://fanyi.baidu.com/appdownload/download.html?tab=desktop&fr=pcproduct'
              }, {
                  type: 'app',
                  title: '百度翻译APP',
                  desc: '学英语背单词必备',
                  downloadUrl: 'https://fanyi.baidu.com/appdownload/download.html?tab=app&appchannel=webbannerfinal&fr=pcproduct'
              }, {
                  type: 'helper',
                  title: '百度AI同传助手',
                  desc: '网课/在线会议实时翻译工具',
                  downloadUrl: 'https://fanyi.baidu.com/appdownload/download.html?tab=helper&fr=pcproduct'
              }, {
                  type: 'meeting',
                  title: '百度AI同传会议版',
                  desc: '企业会议同传解决方案',
                  downloadUrl: 'https://tongchuan.baidu.com?fr=pcproduct'
              }]
          };
          return _this;
      }
              ...
              return _react2.default.createElement(
                  ...
                  productList.map(function (item) {
                      return _react2.default.createElement(
                          'a',
                          {
                              className: (0, _classnames2.default)('products-item', 'products-item-' + item.type),
                              href: item.downloadUrl,
                              key: item.type,
                              target: '_blank',
                              rel: 'noreferrer',
                              onClick: function onClick() {
                                  return _this2.hanldeClick(item.title);
                              }
                          },
                          _react2.default.createElement(
                              'h5',
                          ...
                          _react2.default.createElement('div', { className: 'products-icon' })
                      );
                  })
              );
          }
  ...
  _reactDom2.default.render(_react2.default.createElement(Products, null), document.getElementById('footer-products-container'));

});

;define("translation:widget/footer/footer",function(n){"use strict";n("translation:widget/footer/Products/Products.jsx");var t=(n("translation:widget/translate/input/dataTransfer"),$("#main-outer"),$("#preview-img"),$(".footer")),e=(1+$(".header").innerHeight()+t.innerHeight(),{init:function(){this.bindEvent(),this.documentIsChange()
},bindEvent:function(){$(window).on("resize",this.documentIsChange).on("hashchange",this.documentIsChange)},documentIsChange:function(){}});
$(function(){e.init()})});